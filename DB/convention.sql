...
START TRANSACTION;
USE `conventiondb`;
INSERT INTO `convention` (`id`, `name`, `description`, `date`, `time`, `category_id`, `location_id`) VALUES (1, 'San Diego Comic-con', 'Nerd heaven, The biggest Comic con event in the country', '2023-07-19', '08:00:00', 1, 1);
INSERT INTO `convention` (`id`, `name`, `description`, `date`, `time`, `category_id`, `location_id`) VALUES (2, 'YumiCon', 'celebrate anime culture with your fellow anime community! You can expect to see SPECIAL GUESTS, vendors, artists, performances, panels, video game tournaments and so much more!', '2023-06-02', '09:30:00', 2, 2);
INSERT INTO `convention` (`id`, `name`, `description`, `date`, `time`, `category_id`, `location_id`) VALUES (3, 'QuakeCon', 'The iconic fan gathering welcomes back its dedicated community with a reimagined and upgraded BYOC (Bring-Your-Own-Computer) LAN party for four days of round-the-clock gaming, a host of fun activities, and meetups for old and new friends. ', '2023-08-10', '08:00:00', 3, 3);
INSERT INTO `convention` (`id`, `name`, `description`, `date`, `time`, `category_id`, `location_id`) VALUES (4, 'Kawacon', 'Kawacon is dedicated to bringing out the best of Otaku & Gaming culture in our great city of San Antonio by helping to support and grow our community.', '2023-02-25', '09:00:00', 2, 4);
INSERT INTO `convention` (`id`, `name`, `description`, `date`, `time`, `category_id`, `location_id`) VALUES (5, 'Riverwalk Anime', 'The Riverwalk Anime festival is a chance for anime fans to meet and greet some of their favorite anime stars, such as Sarah Weidenheft, Ryan Colt Levy, and Reagan Murdock.', '2023-04-15', '09:10:00', 2, 4);
INSERT INTO `convention` (`id`, `name`, `description`, `date`, `time`, `category_id`, `location_id`) VALUES (6, 'San Japan', 'San Japan is the Largest Anime & Gaming Convention in the South Texas Region.', '2023-09-01', '8:45:00', 2, 4);
